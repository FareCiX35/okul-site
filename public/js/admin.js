...
const api = async (path, options = {}) => {
  ...
  if (!res.ok) {
    ...
    throw new Error(msg.error || "İşlem başarısız");
  }
  return res.json();
};
...
const fillSections = () => {
  ...
  settingsForm.instagram.value = settings.social.instagram || "";
  settingsForm.youtube.value = settings.social.youtube || "";
  settingsForm.x.value = settings.social.x || "";
        ...
        return `
          <div class="collection-item">
            ...
            <div class="item-actions">
              <button data-action="edit" data-collection="${name}" data-id="${item.id}">Düzenle</button>
